...
from tactical_api import Tank, Antitank, Builder, TurnContext, distance, Tile, Artillery, Airplane
...
commands = []
price_per_piece = {'tank': 8, 'builder': 20, 'artillery': 8, 'antitank': 10, 'airplane': 20}
